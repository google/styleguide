...
Every organization/group has its own style guide: a set of conventions
...
borrowed wholesale from the Google style guide (see the "arbitrary" above),
with tiny, specific changes to better match the prevailing status quo at the
time.
